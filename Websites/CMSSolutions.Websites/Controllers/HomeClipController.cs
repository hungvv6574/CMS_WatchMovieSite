...
namespace CMSSolutions.Websites.Controllers
{
    ...
    public class HomeClipController : BaseHomeController
    {
        private readonly dynamic shapeFactory;
        public HomeClipController(
        ...
        private void BuildModulesCategory(CategoryInfo category)
        {
            ...
            var modelStatistic4 = new DataViewCategoryModel
            {
                Type = (int)HomeDisplayFilmType.StatisticalClips,
                Title = "CLIP XEM NHIỀU NHẤT"
            };

            var viewStatistic4 = viewRenderer.RenderPartialView(Extensions.Constants.Statistic4FilePath, modelStatistic4);
            if (IsVip)
            {
                viewStatistic4 = "<div style=\"margin-top: 125px;\"></div>" + viewStatistic4;
            }
            
            WorkContext.Layout.DisplayStatistic1.Add(new MvcHtmlString(viewStatistic4));
            #endregion
            ...
            modelFirst.ListFilmTypes = filmTypesService.GetByType(WorkContext.CurrentCulture, SiteId, 3).ToList();
            ...
            var totalRow = 0;
            var listFilmCategory = service.GetByClips(
            ...
            var viewFilmFirst = viewRenderer.RenderPartialView(Extensions.Constants.ClipListViewFilePath, modelFirst);
