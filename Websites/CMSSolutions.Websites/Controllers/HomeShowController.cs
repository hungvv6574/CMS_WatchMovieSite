...
namespace CMSSolutions.Websites.Controllers
{
    ...
    public class HomeShowController : BaseHomeController
    {
        private readonly dynamic shapeFactory;
        public HomeShowController(
        ...
        private void BuildModulesCategory(CategoryInfo category)
        {
            ...
            var modelSlider = new DataViewerModel { Data = BuildSlider(SiteId, (int)SliderPages.Show) };
            ...
            {
                Type = (int)HomeDisplayFilmType.StatisticalShows,
                Title = "SHOW XEM NHIỀU NHẤT"
            };
            var viewStatistic3 = viewRenderer.RenderPartialView(Extensions.Constants.Statistic3FilePath, modelStatistic3);
            ...
            var totalRow = 0;
            var listFilmCategory = service.GetByShows(
            ...
            var viewFilmFirst = viewRenderer.RenderPartialView(Extensions.Constants.ShowListViewFilePath, modelFirst);
