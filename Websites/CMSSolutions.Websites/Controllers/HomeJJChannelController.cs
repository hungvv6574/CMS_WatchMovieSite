...
namespace CMSSolutions.Websites.Controllers
{
    ...
    public class HomeJJChannelController : BaseHomeController
    {
        private readonly dynamic shapeFactory;
        public HomeJJChannelController(
        ...
        private void BuildModulesCategory(CategoryInfo category)
        {
            ...
            var modelSlider = new DataViewerModel { Data = BuildSlider(SiteId, (int)SliderPages.JJChannel) };
            ...
            #endregion
            if (category.Id == 9 || category.ParentId == 9)
            {
            ...
            modelFirst.ListFilmTypes = filmTypesService.GetByType(WorkContext.CurrentCulture, SiteId, 4).ToList();
            ...
            var totalRow = 0;
            var listFilmCategory = service.GetByCategoryJJChannelPaged(
            ...
            var viewFilmFirst = viewRenderer.RenderPartialView(Extensions.Constants.CategoryJJListViewFilePath, modelFirst);
