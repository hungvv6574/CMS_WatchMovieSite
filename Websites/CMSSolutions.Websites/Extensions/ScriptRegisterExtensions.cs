...
namespace CMSSolutions.Websites.Extensions
{
    public static class ScriptRegisterExtensions
    {
        ...
        {
            register.Include("jwplayer/swfobject.js").AtFoot();
            register.Include("jwplayer/swf_detect.js").AtFoot();
            register.Include("themesdefaults/jssor.slider.min.js").AtFoot();
            register.Include("themesdefaults/jssor.js").AtFoot();
            register.Include("themesdefaults/ddsmoothmenu.js").AtFoot();
            register.Include("themesdefaults/common.js").AtFoot();
            register.Include("themesdefaults/dialog.js").AtFoot();
            register.Include("raty/jquery.raty.js").AtFoot();
        }

        public static void IncludeJJThemes(this ScriptRegister register)
        {
            register.Include("themesdefaults/dialog.js").AtFoot();
        }
