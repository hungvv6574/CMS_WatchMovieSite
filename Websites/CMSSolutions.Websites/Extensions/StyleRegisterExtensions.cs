...
namespace CMSSolutions.Websites.Extensions
{
    public static class StyleRegisterExtensions
    {
        ...
        public static void IncludeThemesDefaults(this StyleRegister register)
        {
            register.Include("themes/font-awesome.min.css");
            register.Include("fonts/fonts.googleapis.css");
            register.Include("themesdefaults/reset.css");
            register.Include("themesdefaults/theme.css");
            register.Include("themesdefaults/ddsmoothmenu983b.css");
            register.Include("themesdefaults/common.css");
            register.Include("themesdefaults/dialog.css");
        }

        public static void IncludeJJThemes(this StyleRegister register)
        {
            register.Include("themejjviphd/fonts.css");
            register.Include("themejjviphd/reset.css");
            register.Include("themejjviphd/theme.css");
            register.Include("themejjviphd/media.css");
            register.Include("themesdefaults/dialog.css");
        }
